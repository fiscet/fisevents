...
export const useGlobalChecks = () => {
  ...
  useEffect(() => {
    ...
    const redirectTo = `/${curLang}/${CreatorAdminRoutes.getItem('user-account')}`;
  ...
  }, [pathname, router, session.data?.user, curLang, d.action_required, d.missing_user_name, d.missing_company_data, showNotification]);
};
